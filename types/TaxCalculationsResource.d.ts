...
declare module 'stripe' {
  namespace Stripe {
    interface TaxCalculationCreateParams {
      /**
       ...
       */
      line_items: Array<TaxCalculationCreateParams.LineItem>;
       ...
       */
      customer_details?: TaxCalculationCreateParams.CustomerDetails;
    ...
    namespace TaxCalculationCreateParams {
    ...
    interface TaxCalculationListLineItemsParams extends PaginationParams {
      /**
       * Specifies which fields in the response should be expanded.
       */
      expand?: Array<string>;
    ...
    class TaxCalculationsResource {
      ...
      ): Promise<Stripe.Response<Stripe.TaxCalculation>>;
      ...
      listLineItems(
        id: string,
        params?: TaxCalculationListLineItemsParams,
        options?: RequestOptions
