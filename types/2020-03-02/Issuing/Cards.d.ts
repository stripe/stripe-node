  ...
  namespace Stripe {
    namespace Issuing {
      ...
      interface Card {
        ...
        /**
         * [DEPRECATED] The name of the cardholder, printed on the card. Refer to `cardholder.name` instead.
         */
        name?: string;
      ...
      namespace Card {
        interface AuthorizationControls {
          ...
          /**
           * [DEPRECATED] The currency of the card. See [max_amount](https://stripe.com/docs/api#issuing_card_object-authorization_controls-max_amount)
           */
        ...
        interface Shipping {
          ...
          /**
           * [DEPRECATED] Shipment service, such as `standard` or `express`.
           */
        ...
        namespace Shipping {
          ...
          type Service = 'express' | 'overnight' | 'priority' | 'standard';

          type Speed = 'express' | 'overnight' | 'priority' | 'standard';
