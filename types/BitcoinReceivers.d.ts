declare namespace Stripe {
   ...
   */
  export interface BitcoinReceiverListParams {
    /**
   ...
   */
  export interface BitcoinReceiverRetrieveParams {
    /**
     * Specifies which fields in the response should be expanded.
     */
    expand?: Array<string>;
   ...
   */
  export interface BitcoinReceiverListTransactionsParams {
    /**
  ...
  class BitcoinReceiverResource {
    ...
    ): Promise<ApiList<BitcoinReceiver>>;
