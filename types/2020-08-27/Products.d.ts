...
declare module 'stripe-search-beta' {
  namespace Stripe {
    ...
    interface ProductSearchParams {
       ...
       */
      search_window?: ProductSearchParams.SearchWindow;

      /**
       * The order (ascending or descending) that results are listed in. Default: `desc`
       */
      sort_order?: ProductSearchParams.SortOrder;
    }

    namespace ProductSearchParams {
    ...
    class ProductsResource {
      ...
      /**
       * Search for products you've previously created using Stripe's [Search Query Language](https://stripe.com/docs/search-api#search-query-language)
       */
      search(
