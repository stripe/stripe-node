...
///<reference path='./SettingsBrandings.d.ts' />
///<reference path='./BusinessProfiles.d.ts' />
///<reference path='./Capabilities.d.ts' />
///<reference path='./Requirements.d.ts' />
///<reference path='./SettingsCardPayments.d.ts' />
///<reference path='./SettingsDashboards.d.ts' />
///<reference path='./DeclineChargeOns.d.ts' />
///<reference path='./AccountLinks.d.ts' />
///<reference path='./SettingsPayments.d.ts' />
///<reference path='./SettingsPayouts.d.ts' />
///<reference path='./Requirements.d.ts' />
///<reference path='./Settings.d.ts' />
///<reference path='./TosAcceptances.d.ts' />
///<reference path='./Addresses.d.ts' />
///<reference path='./AlipayAccounts.d.ts' />
///<reference path='./AlternateStatementDescriptors.d.ts' />
///<reference path='./StripeErrors.d.ts' />
...
///<reference path='./Inventories.d.ts' />
///<reference path='./Invoices.d.ts' />
///<reference path='./ThresholdItemReasons.d.ts' />
///<reference path='./InvoiceLineItemPeriods.d.ts' />
///<reference path='./CustomFields.d.ts' />
///<reference path='./InvoiceSettings.d.ts' />
///<reference path='./InvoiceSettings.d.ts' />
///<reference path='./TaxAmounts.d.ts' />
///<reference path='./ThresholdReasons.d.ts' />
///<reference path='./TransferData.d.ts' />
///<reference path='./InvoiceItems.d.ts' />
///<reference path='./CustomerTaxIds.d.ts' />
///<reference path='./StatusTransitions.d.ts' />
...
///<reference path='./issuing/MerchantData.d.ts' />
///<reference path='./RequestHistories.d.ts' />
///<reference path='./VerificationData.d.ts' />
///<reference path='./ViolatedAuthorizationControls.d.ts' />
///<reference path='./AuthorizationControls.d.ts' />
///<reference path='./Pins.d.ts' />
///<reference path='./Shippings.d.ts' />
///<reference path='./SpendingLimits.d.ts' />
///<reference path='./Billings.d.ts' />
///<reference path='./AuthorizationControls.d.ts' />
///<reference path='./Companies.d.ts' />
///<reference path='./Documents.d.ts' />
///<reference path='./Individuals.d.ts' />
///<reference path='./DateOfBirths.d.ts' />
///<reference path='./Requirements.d.ts' />
///<reference path='./SpendingLimits.d.ts' />
///<reference path='./Verifications.d.ts' />
///<reference path='./Evidences.d.ts' />
///<reference path='./EvidenceFraudulents.d.ts' />
///<reference path='./EvidenceOthers.d.ts' />
///<reference path='./Companies.d.ts' />
///<reference path='./Verifications.d.ts' />
///<reference path='./VerificationDocuments.d.ts' />
///<reference path='./DateOfBirths.d.ts' />
///<reference path='./JapanAddresses.d.ts' />
///<reference path='./Verifications.d.ts' />
///<reference path='./VerificationDocuments.d.ts' />
///<reference path='./Level3S.d.ts' />
///<reference path='./LineItems.d.ts' />
///<reference path='./Mandates.d.ts' />
///<reference path='./MultiUses.d.ts' />
///<reference path='./PaymentMethodDetails.d.ts' />
///<reference path='./SepaDebits.d.ts' />
///<reference path='./SingleUses.d.ts' />
///<reference path='./EventData.d.ts' />
///<reference path='./EventRequests.d.ts' />
///<reference path='./Offlines.d.ts' />
///<reference path='./Onlines.d.ts' />
///<reference path='./Orders.d.ts' />
///<reference path='./OrderItems.d.ts' />
///<reference path='./OrderReturns.d.ts' />
///<reference path='./PackageDimensions.d.ts' />
///<reference path='./PaymentIntents.d.ts' />
///<reference path='./NextActions.d.ts' />
///<reference path='./NextActionRedirectToUrls.d.ts' />
///<reference path='./PaymentMethodOptions.d.ts' />
///<reference path='./Cards.d.ts' />
///<reference path='./PaymentMethods.d.ts' />
///<reference path='./Cards.d.ts' />
///<reference path='./Checks.d.ts' />
///<reference path='./CardPresents.d.ts' />
///<reference path='./Wallets.d.ts' />
///<reference path='./AmexExpressCheckouts.d.ts' />
///<reference path='./ApplePays.d.ts' />
///<reference path='./GooglePays.d.ts' />
///<reference path='./Masterpasses.d.ts' />
///<reference path='./SamsungPays.d.ts' />
///<reference path='./VisaCheckouts.d.ts' />
///<reference path='./PaymentMethodDetails.d.ts' />
///<reference path='./AchCreditTransfers.d.ts' />
///<reference path='./AchDebits.d.ts' />
///<reference path='./AcssDebits.d.ts' />
///<reference path='./Alipays.d.ts' />
///<reference path='./AuBecsDebits.d.ts' />
///<reference path='./Bancontacts.d.ts' />
///<reference path='./Bitcoins.d.ts' />
///<reference path='./Cards.d.ts' />
///<reference path='./Checks.d.ts' />
///<reference path='./Installments.d.ts' />
///<reference path='./Plans.d.ts' />
///<reference path='./CardPresents.d.ts' />
///<reference path='./Receipts.d.ts' />
///<reference path='./Wallets.d.ts' />
///<reference path='./AmexExpressCheckouts.d.ts' />
///<reference path='./ApplePays.d.ts' />
///<reference path='./GooglePays.d.ts' />
...
///<reference path='./SamsungPays.d.ts' />
///<reference path='./VisaCheckouts.d.ts' />
///<reference path='./Eps.d.ts' />
///<reference path='./Giropays.d.ts' />
///<reference path='./Ideals.d.ts' />
///<reference path='./Klarnas.d.ts' />
///<reference path='./Multibancos.d.ts' />
///<reference path='./P24S.d.ts' />
///<reference path='./SepaCreditTransfers.d.ts' />
///<reference path='./SepaDebits.d.ts' />
///<reference path='./Soforts.d.ts' />
///<reference path='./StripeAccounts.d.ts' />
///<reference path='./Wechats.d.ts' />
///<reference path='./Ideals.d.ts' />
///<reference path='./Installments.d.ts' />
///<reference path='./SepaDebits.d.ts' />
///<reference path='./Payouts.d.ts' />
///<reference path='./Periods.d.ts' />
///<reference path='./Relationships.d.ts' />
///<reference path='./Requirements.d.ts' />
///<reference path='./Plans.d.ts' />
///<reference path='./Tiers.d.ts' />
...
///<reference path='./Radar/Rules.d.ts' />
...
///<reference path='./PaymentMethodOptions.d.ts' />
///<reference path='./Cards.d.ts' />
///<reference path='./ShippingDetails.d.ts' />
///<reference path='./ShippingMethods.d.ts' />
///<reference path='./RunErrors.d.ts' />
///<reference path='./SKUs.d.ts' />
///<reference path='./Sources.d.ts' />
///<reference path='./CodeVerificationFlows.d.ts' />
///<reference path='./SourceMandateNotifications.d.ts' />
///<reference path='./BacsDebitData.d.ts' />
///<reference path='./SepaDebitData.d.ts' />
///<reference path='./Orders.d.ts' />
///<reference path='./OrderItems.d.ts' />
///<reference path='./Owners.d.ts' />
///<reference path='./ReceiverFlows.d.ts' />
///<reference path='./RedirectFlows.d.ts' />
///<reference path='./SourceTransactions.d.ts' />
///<reference path='./AchCreditTransferData.d.ts' />
///<reference path='./ChfCreditTransferData.d.ts' />
///<reference path='./GbpCreditTransferData.d.ts' />
///<reference path='./PaperCheckData.d.ts' />
///<reference path='./SepaCreditTransferData.d.ts' />
///<reference path='./AchCreditTransfers.d.ts' />
///<reference path='./AchDebits.d.ts' />
///<reference path='./AcssDebits.d.ts' />
///<reference path='./Alipays.d.ts' />
...
///<reference path='./BillingThresholds.d.ts' />
///<reference path='./InvoiceCustomerBalanceSettings.d.ts' />
///<reference path='./SubscriptionItems.d.ts' />
///<reference path='./BillingThresholds.d.ts' />
///<reference path='./PendingInvoiceItemIntervals.d.ts' />
///<reference path='./SubscriptionSchedules.d.ts' />
///<reference path='./PhaseItems.d.ts' />
///<reference path='./CurrentPhases.d.ts' />
///<reference path='./Phases.d.ts' />
///<reference path='./RenewalIntervals.d.ts' />
///<reference path='./DefaultSettings.d.ts' />
///<reference path='./TaxDeductedAtSources.d.ts' />
///<reference path='./Verifications.d.ts' />
///<reference path='./TaxInfos.d.ts' />
///<reference path='./TaxInfoVerifications.d.ts' />
...
///<reference path='./ThreeDSecure.d.ts' />
///<reference path='./ThreeDSecure.d.ts' />
///<reference path='./ThreeDSecureUsages.d.ts' />
///<reference path='./Tokens.d.ts' />
///<reference path='./Topups.d.ts' />
///<reference path='./Transfers.d.ts' />
///<reference path='./TransferData.d.ts' />
///<reference path='./PayoutSchedules.d.ts' />
///<reference path='./TransformUsages.d.ts' />
