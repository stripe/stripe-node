...
export interface Alert {
   ...
   */
  api_error?: V2.Core.Health.Alert.ApiError;

  /**
   * Populated when type is api_latency.
   */
  api_latency?: V2.Core.Health.Alert.ApiLatency;

  /**
   * Populated when type is authorization_rate_drop.
   */
  authorization_rate_drop?: V2.Core.Health.Alert.AuthorizationRateDrop;
   ...
   */
  documentation_links: Array<V2.Core.Health.Alert.DocumentationLink>;

  /**
   * Populated when type is elements_error.
   */
  elements_error?: V2.Core.Health.Alert.ElementsError;

  /**
   * Populated when type is event_generation_failure.
   */
  event_generation_failure?: V2.Core.Health.Alert.EventGenerationFailure;

  /**
   * Populated when type is fraud_rate.
   */
  fraud_rate?: V2.Core.Health.Alert.FraudRate;
   ...
   */
  grouping_type: V2.Core.Health.Alert.GroupingType;

  /**
   * Populated when type is invoice_count_dropped.
   */
  invoice_count_dropped?: V2.Core.Health.Alert.InvoiceCountDropped;

  /**
   * Populated when type is issuing_authorization_request_errors.
   */
  issuing_authorization_request_errors?: V2.Core.Health.Alert.IssuingAuthorizationRequestErrors;

  /**
   * Populated when type is issuing_authorization_request_timeout.
   */
  issuing_authorization_request_timeout?: V2.Core.Health.Alert.IssuingAuthorizationRequestTimeout;
   ...
   */
  meter_event_summaries_delayed?: V2.Core.Health.Alert.MeterEventSummariesDelayed;

  /**
   * Populated when type is metronome_notification_latency.
   */
  metronome_notification_latency?: V2.Core.Health.Alert.MetronomeNotificationLatency;

  /**
   * Populated when type is payment_method_error.
   */
  payment_method_error?: V2.Core.Health.Alert.PaymentMethodError;
   ...
   */
  sepa_debit_delayed?: V2.Core.Health.Alert.SepaDebitDelayed;

  /**
   * The severity of the alert.
   */
  severity: V2.Core.Health.Alert.Severity;
   ...
   */
  status: V2.Core.Health.Alert.Status;
   ...
   */
  traffic_volume_drop?: V2.Core.Health.Alert.TrafficVolumeDrop;

  /**
   * The type of the alert. Determines which sub-hash field is populated.
   */
  type: V2.Core.Health.Alert.Type;

  /**
   * Populated when type is webhook_latency.
   */
  webhook_latency?: V2.Core.Health.Alert.WebhookLatency;
}
export namespace V2 {
