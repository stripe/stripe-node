...
export interface AlertHistoryEntry {
   ...
   */
  api_error?: AlertHistoryEntry.ApiError;

  /**
   * Populated when type is api_latency.
   */
  api_latency?: AlertHistoryEntry.ApiLatency;
   ...
   */
  authorization_rate_drop?: AlertHistoryEntry.AuthorizationRateDrop;

  /**
   * Populated when type is elements_error.
   */
  elements_error?: AlertHistoryEntry.ElementsError;

  /**
   * Populated when type is event_generation_failure.
   */
  event_generation_failure?: AlertHistoryEntry.EventGenerationFailure;

  /**
   * Populated when type is fraud_rate.
   */
  fraud_rate?: AlertHistoryEntry.FraudRate;

  /**
   * Populated when type is invoice_count_dropped.
   */
  invoice_count_dropped?: AlertHistoryEntry.InvoiceCountDropped;

  /**
   * Populated when type is issuing_authorization_request_errors.
   */
  issuing_authorization_request_errors?: AlertHistoryEntry.IssuingAuthorizationRequestErrors;

  /**
   * Populated when type is issuing_authorization_request_timeout.
   */
  issuing_authorization_request_timeout?: AlertHistoryEntry.IssuingAuthorizationRequestTimeout;
   ...
   */
  meter_event_summaries_delayed?: AlertHistoryEntry.MeterEventSummariesDelayed;

  /**
   * Populated when type is metronome_notification_latency.
   */
  metronome_notification_latency?: AlertHistoryEntry.MetronomeNotificationLatency;

  /**
   * Populated when type is payment_method_error.
   */
  payment_method_error?: AlertHistoryEntry.PaymentMethodError;

  /**
   * Populated when type is sepa_debit_delayed.
   */
  sepa_debit_delayed?: AlertHistoryEntry.SepaDebitDelayed;

  /**
   * Populated when type is traffic_volume_drop.
   */
  traffic_volume_drop?: AlertHistoryEntry.TrafficVolumeDrop;

  /**
   * The type of transition that occurred.
   */
  transition: AlertHistoryEntry.Transition;
   ...
   */
  webhook_latency?: AlertHistoryEntry.WebhookLatency;
}
