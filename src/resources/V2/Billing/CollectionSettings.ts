...
export class CollectionSettingResource extends StripeResource {
  ...
  ): V2ListPromise<CollectionSetting> {
...
export interface CollectionSetting {
   ...
   */
  payment_method_options?: V2.Billing.CollectionSetting.PaymentMethodOptions;
}
export namespace V2 {
  export namespace Billing {
    export namespace CollectionSetting {
...
export namespace V2 {
  export namespace Billing {
    export interface CollectionSettingRetrieveParams {}
  }
}
export namespace V2 {
  export namespace Billing {
...
export namespace V2 {
  export namespace Billing {
    export interface CollectionSettingListParams {
      /**
