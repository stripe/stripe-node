...
export class PaymentProfileResource extends StripeResource {
   ...
   */
  updateLimit(
    params: V2.Provisioning.PaymentProfileUpdateLimitParams,
    options?: RequestOptions
  ): Promise<Response<PaymentProfile>> {
    return this._makeRequest(
      'POST',
...
export namespace V2 {
  export namespace Provisioning {
    export interface PaymentProfileUpdateLimitParams {
      /**
       * New usage limit to apply.
       */
      usage_limits: PaymentProfileUpdateLimitParams.UsageLimits;
    ...
    export namespace PaymentProfileUpdateLimitParams {
      export interface UsageLimits {
        /**
         * Three-letter ISO currency code for `max_amount`.
         */
