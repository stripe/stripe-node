...
export class InvoiceResource extends StripeResource {
  ...
  serializeBatchUpdateLineItem(
    ...
    entry.path_params = {invoice_id: invoiceId, id: id};
    if (options.stripeContext) {
      entry.context = options.stripeContext;
    }
    return JSON.stringify(entry);
...
export interface Invoice {
  ...
  managed_payments?: Invoice.ManagedPayments | null;
   ...
   */
  payment_plan?: string | PaymentPlan;
...
export namespace Invoice {
  ...
  export interface TotalMarginAmount {
    /**
  ...
  export interface TotalPretaxCreditAmount {
    /**
  ...
  export namespace Parent {
    export interface BillingCadenceDetails {
      /**
...
export interface InvoiceCreateParams {
   ...
   */
  managed_payments?: InvoiceCreateParams.ManagedPayments;
