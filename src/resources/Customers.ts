...
export class CustomerResource extends StripeResource {
  ...
  deleteTaxExemption(
    customerId: string,
    id: string,
    params?: CustomerDeleteTaxExemptionParams,
    options?: RequestOptions
  ): Promise<Response<DeletedCustomerTaxExemption>> {
    return this._makeRequest(
      'DELETE',
      `/v1/customers/${encodeURIComponent(
        customerId
      )}/tax_exemptions/${encodeURIComponent(id)}`,
      params,
      options
    ) as any;
  }
   ...
   */
  retrieveTaxExemption(
    customerId: string,
    id: string,
    params?: CustomerRetrieveTaxExemptionParams,
    options?: RequestOptions
  ): Promise<Response<CustomerTaxExemption>> {
    return this._makeRequest(
      'GET',
      `/v1/customers/${encodeURIComponent(
        customerId
  ...
  listTaxExemptions(
    id: string,
    params?: CustomerListTaxExemptionsParams,
    options?: RequestOptions
  ): ApiListPromise<CustomerTaxExemption> {
    return this._makeRequest(
      'GET',
      `/v1/customers/${encodeURIComponent(id)}/tax_exemptions`,
      params,
      options,
      {
        methodType: 'list',
  ...
  createTaxExemption(
    id: string,
    params: CustomerCreateTaxExemptionParams,
    options?: RequestOptions
  ): Promise<Response<CustomerTaxExemption>> {
    return this._makeRequest(
      'POST',
...
export interface CustomerCreateTaxExemptionParams {
  /**
   ...
   */
  us?: CustomerCreateTaxExemptionParams.Us;
}
export namespace CustomerCreateTaxExemptionParams {
  ...
  export namespace Ca {
    export type TaxType = 'gst_hst' | 'pst' | 'qst' | 'rst' | OtherString;
  }
}
...
export interface CustomerDeleteTaxExemptionParams {}
...
export interface CustomerListTaxExemptionsParams extends PaginationParams {
  /**
...
export interface CustomerRetrieveTaxExemptionParams {
  /**
   * Specifies which fields in the response should be expanded.
   */
  expand?: Array<string>;
...
export interface CustomerSerializeBatchCreateParams {}
export interface CustomerSerializeBatchCreateBalanceTransactionParams {}
export interface CustomerSerializeBatchCreateForCustomerTaxIdParams {}
export interface CustomerSerializeBatchCreateFundingInstructionsFundingInstructionsParams {}
export interface CustomerSerializeBatchCreateSourceParams {}
export interface CustomerSerializeBatchDeleteParams {}
export interface CustomerSerializeBatchDeleteDiscountParams {}
export interface CustomerSerializeBatchDeleteSourceParams {}
export interface CustomerSerializeBatchDeleteTaxIdParams {}
export interface CustomerSerializeBatchUpdateParams {}
export interface CustomerSerializeBatchUpdateBalanceTransactionParams {}
export interface CustomerSerializeBatchUpdateCashBalanceParams {}
export interface CustomerSerializeBatchUpdateSourceParams {}
export interface CustomerSerializeBatchVerifySourceParams {}
