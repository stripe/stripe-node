...
export interface OrderEvent {
   ...
   */
  adjustment: DelegatedCheckout.OrderEvent.Adjustment | null;
   ...
   */
  fulfillment: DelegatedCheckout.OrderEvent.Fulfillment | null;
   ...
   */
  type: DelegatedCheckout.OrderEvent.Type;
}
