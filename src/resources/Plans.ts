...
export class PlanResource extends StripeResource {
  ...
  retrieve<E extends string = never>(
    id: string,
    params?: PlanRetrieveParams<E>,
    options?: RequestOptions
  ): Promise<Response<ApplyExpand<Plan, E>>> {
    return this._makeRequest(
      'GET',
      `/v1/plans/${encodeURIComponent(id)}`,
      params,
  ...
  list<E extends string = never>(
    params?: PlanListParams<E>,
    options?: RequestOptions
  ): ApiListPromise<ApplyExpandListItem<Plan, E>> {
...
export interface PlanCreateParams<E extends string = string> {
  /**
   * Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
   */
  currency: string;
...
export interface PlanRetrieveParams<E extends string = string> {
  /**
   * Specifies which fields in the response should be expanded.
   */
  expand?: Array<E>;
}
export interface PlanUpdateParams<E extends string = string> {
  /**
...
export interface PlanListParams<E extends string = string>
