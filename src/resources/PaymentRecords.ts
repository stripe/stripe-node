...
export class PaymentRecordResource extends StripeResource {
  ...
  create(
    ...
    return this._makeRequest(
      'POST',
      `/v1/payment_records/${encodeURIComponent(id)}/report_dispute`,
      params,
      options
    ) as any;
  }
...
export interface PaymentRecordReportPaymentAttemptGuaranteedParams {
   ...
   * Information about the Payment Method debited for this payment.
   */
  payment_method_details?: PaymentRecordReportPaymentAttemptGuaranteedParams.PaymentMethodDetails;
...
export interface PaymentRecordReportRefundParams {
   ...
   */
  failed?: PaymentRecordReportRefundParams.Failed;
