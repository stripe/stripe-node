...
export class PaymentAttemptRecordResource extends StripeResource {
  ...
  reportAuthorized(
    ...
    return this._makeRequest(
      'POST',
      `/v1/payment_attempt_records/${encodeURIComponent(id)}/report_authorized`,
      params,
      options
    ) as any;
  }
  ...
  reportCanceled(
    ...
    return this._makeRequest(
      'POST',
      `/v1/payment_attempt_records/${encodeURIComponent(id)}/report_canceled`,
      params,
      options
    ) as any;
  }
  ...
  reportFailed(
    ...
    return this._makeRequest(
      'POST',
      `/v1/payment_attempt_records/${encodeURIComponent(id)}/report_failed`,
      params,
      options
    ) as any;
  }
  ...
  reportGuaranteed(
    ...
    return this._makeRequest(
      'POST',
      `/v1/payment_attempt_records/${encodeURIComponent(id)}/report_guaranteed`,
      params,
      options
    ) as any;
  }
  ...
  reportRefund(
    ...
    return this._makeRequest(
      'POST',
      `/v1/payment_attempt_records/${encodeURIComponent(id)}/report_refund`,
      params,
      options
    ) as any;
  }
...
export namespace PaymentAttemptRecord {
  ...
  export namespace PaymentMethodDetails {
    ...
    export interface GiftCard {
       ...
       */
      balance: GiftCard.Balance | null;

      /**
       * The brand of the gift card.
       */
      brand: GiftCard.Brand | null;
...
export interface PaymentAttemptRecordReportAuthenticatedParams {
  /**
...
export interface PaymentAttemptRecordReportFailedParams {
   ...
   * Information about the Payment Method debited for this payment.
   */
  payment_method_details?: PaymentAttemptRecordReportFailedParams.PaymentMethodDetails;
...
export interface PaymentAttemptRecordReportGuaranteedParams {
  /**
   * Specifies which fields in the response should be expanded.
   */
  expand?: Array<string>;
   ...
   * Information about the Payment Method debited for this payment.
   */
  payment_method_details?: PaymentAttemptRecordReportGuaranteedParams.PaymentMethodDetails;
...
export interface PaymentAttemptRecordReportInformationalParams {
  /**
   * Customer information for this payment.
   */
...
export interface PaymentAttemptRecordReportRefundParams {
   ...
   */
  failed?: PaymentAttemptRecordReportRefundParams.Failed;
   ...
   */
  reason?: PaymentAttemptRecordReportRefundParams.Reason;
