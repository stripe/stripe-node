...
export class AuthorizationResource extends StripeResource {
  ...
  finalizeAmount(...args: any[]): Promise<Response<any>> {
    return stripeMethod({
      method: 'POST',
      fullPath:
  ...
  respond(...args: any[]): Promise<Response<any>> {
    return stripeMethod({
      method: 'POST',
      fullPath:
  ...
  increment(...args: any[]): Promise<Response<any>> {
    return stripeMethod({
      method: 'POST',
      fullPath:
...
export namespace TestHelpers {
  export namespace Issuing {
    ...
    export namespace AuthorizationCreateParams {
      ...
      export type FraudDisputabilityLikelihood =
        | 'neutral'
        | 'unknown'
        | 'very_likely'
        | 'very_unlikely';
      ...
      export namespace RiskAssessment {
        export interface CardTestingRisk {
          /**
        ...
        export interface MerchantDisputeRisk {
          /**
        ...
        export namespace CardTestingRisk {
...
export namespace TestHelpers {
  export namespace Issuing {
    ...
    export namespace AuthorizationFinalizeAmountParams {
      export interface Fleet {
        /**
         * Answers to prompts presented to the cardholder at the point of sale. Prompted fields vary depending on the configuration of your physical fleet cards. Typical points of sale support only numeric entry.
         */
