...
export declare namespace TestHelpers {
  export import TestClockDeleteParams = TestHelpersNamespace4.TestClockDeleteParams;
  export import TestClockRetrieveParams = TestHelpersNamespace4.TestClockRetrieveParams;
