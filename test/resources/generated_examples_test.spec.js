...
describe('Generated tests', function() {
  ...
  it('test_cannot_proceed_error', async function() {
    ...
    nock('https://api.stripe.com')
      .post('/v2/money_management/payout_methods/id_123/archive')
      .reply(400, {
        error: {
          type: 'cannot_proceed',
    ...
    try {
      await realStripe.v2.moneyManagement.payoutMethods.archive('id_123');
      expect.fail('Expected error');
    } catch (err) {
