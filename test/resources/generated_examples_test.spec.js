...
describe('Generated tests', function() {
    ...
    const stripe = testUtils.createMockClient([
      {
        ...
        response:
          '{"data":[{"object":"v2.core.approval_request","action":"refund.create","created":"1970-01-12T21:42:34.472Z","expires_at":"1970-01-10T15:36:51.170Z","id":"obj_123","livemode":true,"requested_by":{"type":"api_key"},"status":"failed"}],"next_page_url":null,"previous_page_url":null}',
      },
    ]);
    ...
    const stripe = testUtils.createMockClient([
      {
        ...
        response:
          '{"object":"v2.core.approval_request","action":"refund.create","created":"1970-01-12T21:42:34.472Z","expires_at":"1970-01-10T15:36:51.170Z","id":"obj_123","livemode":true,"requested_by":{"type":"api_key"},"status":"failed"}',
      },
    ]);
  ...
  it('test_v2_core_approval_request_post', async function() {
    ...
    const approvalRequest = await stripe.v2.core.approvalRequests.update(
      'id_123'
    );
    expect(approvalRequest).not.to.be.null;
  });
    ...
    const stripe = testUtils.createMockClient([
      {
        ...
        response:
          '{"data":[{"object":"v2.core.fee_batch","amount":{"currency":"usd","value":"value"},"collected_by":{"type":"application"},"collection_records":[{"amount":{"currency":"usd","value":"value"},"type":"balance_transaction"}],"created":"1970-01-12T21:42:34.472Z","id":"obj_123","livemode":true,"status":"billed","status_transitions":{}}],"next_page_url":null,"previous_page_url":null}',
      },
    ]);
    ...
    const stripe = testUtils.createMockClient([
      {
        ...
        response:
          '{"object":"v2.core.fee_batch","amount":{"currency":"usd","value":"value"},"collected_by":{"type":"application"},"collection_records":[{"amount":{"currency":"usd","value":"value"},"type":"balance_transaction"}],"created":"1970-01-12T21:42:34.472Z","id":"obj_123","livemode":true,"status":"billed","status_transitions":{}}',
      },
    ]);
  ...
  it('test_v2_core_vault_network_token_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const networkToken = await stripe.v2.core.vault.networkTokens.create({
      type: 'card',
    });
    expect(networkToken).not.to.be.null;
  });

  it('test_v2_core_vault_network_token_post_2', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const networkToken = await stripe.v2.core.vault.networkTokens.createFromCredential(
      {
        type: 'card',
      }
    );
  ...
  it('test_v2_core_vault_network_token_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
    ...
    const networkToken = await stripe.v2.core.vault.networkTokens.retrieve(
      'id_123'
    );
    expect(networkToken).not.to.be.null;
  });

  it('test_v2_core_vault_network_token_post_3', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const networkToken = await stripe.v2.core.vault.networkTokens.generateCryptogram(
      'id_123'
    );
    expect(networkToken).not.to.be.null;
  });
    ...
    const stripe = testUtils.createMockClient([
      {
        ...
        path: '/v2/core/vault/us_bank_accounts',
        response:
          '{"object":"v2.core.vault.us_bank_account","archived":true,"bank_account_type":"savings","bank_name":"bank_name","created":"1970-01-12T21:42:34.472Z","id":"obj_123","last4":"last4","livemode":true,"restricted":true,"supported_currencies":["supported_currencies"],"verification":{"status":"verification_failed"}}',
      },
    ]);
  ...
  it('test_v2_money_management_earned_credit_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
    ...
    const earnedCredits = await stripe.v2.moneyManagement.earnedCredits.list();
    expect(earnedCredits).not.to.be.null;
  });

  it('test_v2_money_management_earned_credit_get_2', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
        path: '/v2/money_management/earned_credits/id_123',
        response:
    ...
    const earnedCredit = await stripe.v2.moneyManagement.earnedCredits.retrieve(
      'id_123'
    );
    expect(earnedCredit).not.to.be.null;
  });
  ...
  it('test_v2_money_management_financial_accounts_wallet_export_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
        path: '/v2/money_management/financial_accounts/id_123/wallet_export',
        response:
    ...
    const financialAccountWalletExport = await stripe.v2.moneyManagement.financialAccounts.walletExport.retrieve(
      'id_123'
    );
    expect(financialAccountWalletExport).not.to.be.null;
  });

  it('test_v2_money_management_financial_accounts_wallet_export_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path:
    ...
    const financialAccountWalletExportCredentials = await stripe.v2.moneyManagement.financialAccounts.walletExport.exportCredentials(
      'id_123',
      {
        encryption: {
    ...
    expect(financialAccountWalletExportCredentials).not.to.be.null;
  });
    ...
    const stripe = testUtils.createMockClient([
      {
        ...
        response:
          '{"data":[{"object":"v2.money_management.payout_intent","amount":{"currency":"USD","value":96},"confirmation_method":"manual","created":"1970-01-12T21:42:34.472Z","from":{"currency":"usd","financial_account":"financial_account"},"id":"obj_123","latest_payout":{"type":"outbound_payment"},"livemode":true,"status":"canceled","to":{}}],"next_page_url":null,"previous_page_url":null}',
      },
    ]);
    ...
    const stripe = testUtils.createMockClient([
      {
        ...
        path: '/v2/money_management/payout_intents',
        response:
          '{"object":"v2.money_management.payout_intent","amount":{"currency":"USD","value":96},"confirmation_method":"manual","created":"1970-01-12T21:42:34.472Z","from":{"currency":"usd","financial_account":"financial_account"},"id":"obj_123","latest_payout":{"type":"outbound_payment"},"livemode":true,"status":"canceled","to":{}}',
      },
    ]);
  ...
  it('test_v2_money_management_payout_intent_post_4', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const payoutIntent = await stripe.v2.moneyManagement.payoutIntents.confirm(
      'id_123'
    );
    expect(payoutIntent).not.to.be.null;
  });

  it('test_v2_money_management_payout_intent_post_5', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const payoutIntent = await stripe.v2.moneyManagement.payoutIntents.fxQuote(
      'id_123'
    );
    expect(payoutIntent).not.to.be.null;
  });
  ...
  it('test_v2_money_management_payout_method_post_2', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/money_management/payout_methods/id_123/disable',
        response:
          '{"object":"v2.money_management.payout_method","archived":true,"available_payout_speeds":["standard"],"created":"1970-01-12T21:42:34.472Z","id":"obj_123","livemode":true,"restricted":true,"type":"apple_pay","usage_status":{"payments":"invalid","transfers":"invalid"}}',
      },
    ]);
    const payoutMethod = await stripe.v2.moneyManagement.payoutMethods.disable(
      'id_123'
    );
    expect(payoutMethod).not.to.be.null;
  });

  it('test_v2_money_management_payout_method_post_3', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
  ...
  it('test_v2_money_management_test_helper_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const earnedCreditSimulation = await stripe.v2.moneyManagement.testHelpers.earnedCredits(
      {
        amount: {
          value: 96,
          currency: 'USD',
    ...
    expect(earnedCreditSimulation).not.to.be.null;
  });
  ...
  it('test_v2_money_management_test_helpers_financial_address_post', async function() {
    ...
    const financialAddressCreditSimulation = await stripe.v2.moneyManagement.testHelpers.financialAddresses.credit(
      'id_123',
      {
        amount: {
          value: 96,
  ...
  it('test_v2_money_management_test_helpers_financial_address_post_2', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path:
  ...
  it('test_v2_money_management_test_helpers_financial_address_post_3', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path:
    ...
    const financialAddressGeneratedMicrodeposits = await stripe.v2.moneyManagement.testHelpers.financialAddresses.generateMicrodeposits(
      'id_123'
    );
  ...
  it('test_v2_money_management_transaction_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/money_management/transactions/id_123',
    ...
    const transaction = await stripe.v2.moneyManagement.transactions.update(
      'id_123'
    );
    expect(transaction).not.to.be.null;
  });
  ...
  it('test_v2_provisioning_catalog_provider_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
    ...
    const providers = await stripe.v2.provisioning.catalog.providers.list();
    expect(providers).not.to.be.null;
  });

  it('test_v2_provisioning_catalog_service_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
    ...
    const providerServiceDetails = await stripe.v2.provisioning.catalog.services.list();
    expect(providerServiceDetails).not.to.be.null;
  });

  it('test_v2_provisioning_eligibility_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
    ...
    const eligibility = await stripe.v2.provisioning.eligibilities.retrieve();
    expect(eligibility).not.to.be.null;
  });

  it('test_v2_provisioning_payment_method_request_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const paymentMethodRequest = await stripe.v2.provisioning.paymentMethodRequests.create();
    expect(paymentMethodRequest).not.to.be.null;
  });

  it('test_v2_provisioning_payment_profile_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
    ...
    const paymentProfile = await stripe.v2.provisioning.paymentProfiles.retrieve();
    expect(paymentProfile).not.to.be.null;
  });

  it('test_v2_provisioning_payment_profile_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const paymentProfile = await stripe.v2.provisioning.paymentProfiles.updateLimit(
      {
        usage_limits: {
          currency: 'usd',
  ...
  it('test_v2_provisioning_project_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const project = await stripe.v2.provisioning.projects.create({
      name: 'name',
    });
    expect(project).not.to.be.null;
  });

  it('test_v2_provisioning_provider_connection_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
    ...
    const providerConnections = await stripe.v2.provisioning.providerConnections.list();
    expect(providerConnections).not.to.be.null;
  });

  it('test_v2_provisioning_provider_connection_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/provisioning/provider_connections/id_123/unlink',
        response:
          '{"object":"v2.provisioning.provider_connection","id":"obj_123","livemode":true,"provider":"provider","status":"active"}',
      },
    ]);
    const providerConnection = await stripe.v2.provisioning.providerConnections.unlink(
      'id_123'
    );
    expect(providerConnection).not.to.be.null;
  });

  it('test_v2_provisioning_provider_connection_request_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const providerConnectionRequest = await stripe.v2.provisioning.providerConnectionRequests.create(
      {
        configuration: {
          int_key: 123,
          string_key: 'value',
    ...
    expect(providerConnectionRequest).not.to.be.null;
  });

  it('test_v2_provisioning_provider_connection_request_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
        path: '/v2/provisioning/provider_connection_requests/id_123',
        response:
          '{"object":"v2.provisioning.provider_connection_request","id":"obj_123","livemode":true,"provider":"provider","request_status":"error","scopes":["scopes"]}',
      },
    ]);
    const providerConnectionRequest = await stripe.v2.provisioning.providerConnectionRequests.retrieve(
      'id_123'
    );
    expect(providerConnectionRequest).not.to.be.null;
  });

  it('test_v2_provisioning_provider_connection_request_post_2', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path:
    ...
    const providerConnectionRequest = await stripe.v2.provisioning.providerConnectionRequests.submitInformation(
      'id_123',
      {
        information: {
          int_key: 123,
  ...
  it('test_v2_provisioning_resource_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const resource = await stripe.v2.provisioning.resources.create({
      configuration: {
        int_key: 123,
        string_key: 'value',
        boolean_key: true,
  ...
  it('test_v2_provisioning_resource_post_2', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const resource = await stripe.v2.provisioning.resources.link({
      provider: 'provider',
      service_ref: 'service_ref',
    });
    expect(resource).not.to.be.null;
  ...
  it('test_v2_provisioning_resource_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
        path: '/v2/provisioning/resources/id_123',
        response:
          '{"object":"v2.provisioning.resource","created":"1970-01-12T21:42:34.472Z","environment":"prod","id":"obj_123","livemode":true,"provider":"provider","service_ref":"service_ref","status":"complete"}',
      },
    ]);
    const resource = await stripe.v2.provisioning.resources.retrieve('id_123');
    expect(resource).not.to.be.null;
  });

  it('test_v2_provisioning_resource_post_3', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/provisioning/resources/id_123',
    ...
    const resource = await stripe.v2.provisioning.resources.update('id_123');
    expect(resource).not.to.be.null;
  });

  it('test_v2_provisioning_resource_post_4', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/provisioning/resources/id_123/remove',
        response:
          '{"object":"v2.provisioning.resource","created":"1970-01-12T21:42:34.472Z","environment":"prod","id":"obj_123","livemode":true,"provider":"provider","service_ref":"service_ref","status":"complete"}',
      },
    ]);
    const resource = await stripe.v2.provisioning.resources.remove('id_123');
    expect(resource).not.to.be.null;
  });

  it('test_v2_provisioning_resource_post_5', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/provisioning/resources/id_123/rotate_credentials',
        response:
          '{"object":"v2.provisioning.resource","created":"1970-01-12T21:42:34.472Z","environment":"prod","id":"obj_123","livemode":true,"provider":"provider","service_ref":"service_ref","status":"complete"}',
      },
    ]);
    const resource = await stripe.v2.provisioning.resources.rotateCredentials(
      'id_123'
    );
    expect(resource).not.to.be.null;
  });

  it('test_v2_provisioning_resource_post_6', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/provisioning/resources/id_123/submit_information',
        response:
          '{"object":"v2.provisioning.resource","created":"1970-01-12T21:42:34.472Z","environment":"prod","id":"obj_123","livemode":true,"provider":"provider","service_ref":"service_ref","status":"complete"}',
      },
    ]);
    const resource = await stripe.v2.provisioning.resources.submitInformation(
      'id_123',
      {
  ...
  it('test_v2_provisioning_resource_post_7', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/provisioning/resources/id_123/unlink',
        response:
          '{"object":"v2.provisioning.resource","created":"1970-01-12T21:42:34.472Z","environment":"prod","id":"obj_123","livemode":true,"provider":"provider","service_ref":"service_ref","status":"complete"}',
      },
    ]);
    const resource = await stripe.v2.provisioning.resources.unlink('id_123');
    expect(resource).not.to.be.null;
  });
  ...
  it('test_v2_signals_payment_retry_evaluation_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const paymentRetryEvaluation = await stripe.v2.signals.paymentRetryEvaluations.create();
    expect(paymentRetryEvaluation).not.to.be.null;
  });

  it('test_v2_signals_payment_retry_evaluation_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
        path: '/v2/signals/payment_retry_evaluations/id_123',
        response:
          '{"object":"v2.signals.payment_retry_evaluation","created":"1970-01-12T21:42:34.472Z","id":"obj_123","latest_signal":{"object":"v2.signals.payment_retry_signal","created":"1970-01-12T21:42:34.472Z","evaluation":"evaluation","id":"obj_123","livemode":true,"recommendation":{"action":"wait","reason":"reason"}},"livemode":true,"status":"expired"}',
      },
    ]);
    const paymentRetryEvaluation = await stripe.v2.signals.paymentRetryEvaluations.retrieve(
      'id_123'
    );
    expect(paymentRetryEvaluation).not.to.be.null;
  });

  it('test_v2_signals_payment_retry_evaluation_post_2', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/signals/payment_retry_evaluations/id_123',
    ...
    const paymentRetryEvaluation = await stripe.v2.signals.paymentRetryEvaluations.update(
      'id_123'
    );
    expect(paymentRetryEvaluation).not.to.be.null;
  });

  it('test_v2_signals_payment_retry_evaluation_post_3', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/signals/payment_retry_evaluations/id_123/cancel',
        response:
          '{"object":"v2.signals.payment_retry_evaluation","created":"1970-01-12T21:42:34.472Z","id":"obj_123","latest_signal":{"object":"v2.signals.payment_retry_signal","created":"1970-01-12T21:42:34.472Z","evaluation":"evaluation","id":"obj_123","livemode":true,"recommendation":{"action":"wait","reason":"reason"}},"livemode":true,"status":"expired"}',
      },
    ]);
    const paymentRetryEvaluation = await stripe.v2.signals.paymentRetryEvaluations.cancel(
      'id_123'
    );
    expect(paymentRetryEvaluation).not.to.be.null;
  });

  it('test_v2_signals_payment_retry_signal_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
        path: '/v2/signals/payment_retry_signals/id_123',
        response:
    ...
    const paymentRetrySignal = await stripe.v2.signals.paymentRetrySignals.retrieve(
      'id_123'
    );
    expect(paymentRetrySignal).not.to.be.null;
  });

  it('test_v2_tax_integration_configuration_get', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'GET',
    ...
    const integrationConfiguration = await stripe.v2.tax.integrationConfigurations.retrieve();
    expect(integrationConfiguration).not.to.be.null;
  });

  it('test_v2_tax_integration_configuration_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
        path: '/v2/tax/integration_configurations',
    ...
    const integrationConfiguration = await stripe.v2.tax.integrationConfigurations.update();
    expect(integrationConfiguration).not.to.be.null;
  });
  ...
  it('test_v2_tax_operation_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const operationsResolveAddressResult = await stripe.v2.tax.operations.resolveAddress(
      {
        address: {
          city: 'city',
          country: 'country',
    ...
    expect(operationsResolveAddressResult).not.to.be.null;
  });
  ...
  it('test_already_exists_error', async function() {
    ...
    try {
      await realStripe.v2.billing.contracts.create({
        contract_number: 'contract_number',
        currency: 'usd',
      });
      expect.fail('Expected error');
  ...
  it('test_blocked_by_stripe_error', async function() {
    ...
    try {
      await realStripe.v2.core.vault.gbBankAccounts.create({
        currency: 'usd',
      });
      expect.fail('Expected error');
    } catch (err) {
  ...
  it('test_cannot_proceed_error', async function() {
    ...
    nock('https://api.stripe.com')
      .post('/v2/billing/contracts/id_123')
      .reply(400, {
        error: {
          type: 'cannot_proceed',
    ...
    try {
      await realStripe.v2.billing.contracts.update('id_123');
      expect.fail('Expected error');
    } catch (err) {
  ...
  it('test_controlled_by_alternate_resource_error', async function() {
    ...
    nock('https://api.stripe.com')
      .post('/v2/core/vault/gb_bank_accounts/id_123/archive')
      .reply(400, {
        error: {
    ...
    try {
      await realStripe.v2.core.vault.gbBankAccounts.archive('id_123');
      expect.fail('Expected error');
    } catch (err) {
  ...
  it('test_fx_quote_needs_refresh_error', async function() {
    const {FxQuoteNeedsRefreshError} = require('../../src/Error.js');

    nock('https://api.stripe.com')
      .post('/v2/money_management/payout_intents/id_123/confirm')
      .reply(400, {
        error: {
    ...
    try {
      await realStripe.v2.moneyManagement.payoutIntents.confirm('id_123');
      expect.fail('Expected error');
    } catch (err) {
      expect(err).to.be.instanceOf(FxQuoteNeedsRefreshError);
    }
  });
  ...
  it('test_invalid_vaulted_credential_error', async function() {
    const {InvalidVaultedCredentialError} = require('../../src/Error.js');
    ...
    try {
      ...
      expect(err).to.be.instanceOf(InvalidVaultedCredentialError);
    }
  });

  it('test_merchant_not_gated_error', async function() {
    const {MerchantNotGatedError} = require('../../src/Error.js');

    nock('https://api.stripe.com')
      .post('/v2/core/vault/network_tokens')
      .reply(400, {
        error: {
    ...
    try {
      await realStripe.v2.core.vault.networkTokens.create({
        type: 'card',
      });
      expect.fail('Expected error');
    } catch (err) {
      expect(err).to.be.instanceOf(MerchantNotGatedError);
    }
  });
  ...
  it('test_rate_limit_error', async function() {
    ...
    nock('https://api.stripe.com')
      .delete('/v2/billing/contracts/id_123')
      .reply(400, {
        error: {
          type: 'rate_limit',
    ...
    try {
      await realStripe.v2.billing.contracts.del('id_123');
      expect.fail('Expected error');
    } catch (err) {
  ...
  it('test_service_unavailable_error', async function() {
    const {ServiceUnavailableError} = require('../../src/Error.js');
    ...
    try {
      await realStripe.v2.moneyManagement.financialAccounts.walletExport.exportCredentials(
        'id_123',
        {
          encryption: {
            recipient_public_key: 'recipient_public_key',
  ...
  it('test_verification_attempt_failed_error', async function() {
    const {VerificationAttemptFailedError} = require('../../src/Error.js');
    ...
    try {
      ...
      expect(err).to.be.instanceOf(VerificationAttemptFailedError);
    }
  });

  it('test_verification_expired_error', async function() {
    const {VerificationExpiredError} = require('../../src/Error.js');
    ...
    try {
      ...
      expect(err).to.be.instanceOf(VerificationExpiredError);
    }
  });

  it('test_verification_not_initiated_error', async function() {
    const {VerificationNotInitiatedError} = require('../../src/Error.js');
    ...
    try {
      ...
      expect(err).to.be.instanceOf(VerificationNotInitiatedError);
    }
  });
});
