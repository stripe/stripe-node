...
describe('Generated tests', function() {
  ...
  it('test_v2_provisioning_payment_profile_update_limit_post', async function() {
    const stripe = testUtils.createMockClient([
      {
        method: 'POST',
    ...
    const paymentProfile = await stripe.v2.provisioning.paymentProfiles.updateLimit.update(
      {
        usage_limits: {
          currency: 'usd',
