...
import { Response, ApiListPromise, ApiList, ApiSearchResultPromise } from '../lib.js';
export declare class SubscriptionResource extends StripeResource {
    ...
    retrieve(id: string, options?: RequestOptions): Promise<Response<Subscription>>;
    /**
    ...
    resume(id: string, options?: RequestOptions): Promise<Response<Subscription>>;
}
export /**
