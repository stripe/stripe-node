...
export declare class AuthorizationResource extends StripeResource {
    ...
    capture(id: string, options?: RequestOptions): Promise<Response<Authorization>>;
    /**
    ...
    expire(id: string, options?: RequestOptions): Promise<Response<Authorization>>;
    /**
    ...
    reverse(id: string, options?: RequestOptions): Promise<Response<Authorization>>;
}
