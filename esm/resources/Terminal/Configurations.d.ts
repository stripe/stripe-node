...
export declare class ConfigurationResource extends StripeResource {
    ...
    del(id: string, options?: RequestOptions): Promise<Response<Terminal.DeletedConfiguration>>;
    /**
    ...
    retrieve(id: string, options?: RequestOptions): Promise<Response<Configuration | Terminal.DeletedConfiguration>>;
    /**
