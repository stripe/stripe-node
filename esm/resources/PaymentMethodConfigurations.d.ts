...
export declare class PaymentMethodConfigurationResource extends StripeResource {
    ...
    create(options?: RequestOptions): Promise<Response<PaymentMethodConfiguration>>;
    /**
    ...
    retrieve(id: string, options?: RequestOptions): Promise<Response<PaymentMethodConfiguration>>;
    /**
