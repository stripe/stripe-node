...
export declare class TransferResource extends StripeResource {
    ...
    listReversals(id: string, options?: RequestOptions): ApiListPromise<TransferReversal>;
    /**
    ...
    createReversal(id: string, options?: RequestOptions): Promise<Response<TransferReversal>>;
    /**
    ...
    retrieveReversal(transferId: string, id: string, options?: RequestOptions): Promise<Response<TransferReversal>>;
    /**
