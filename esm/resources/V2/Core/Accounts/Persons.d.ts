...
import { MetadataParam, JapanAddressParam } from '../../../../shared.js';
...
export declare class PersonResource extends StripeResource {
    ...
    create(id: string, options?: RequestOptions): Promise<Response<AccountPerson>>;
    /**
    ...
    del(accountId: string, id: string, options?: RequestOptions): Promise<Response<DeletedObject>>;
    /**
    ...
    retrieve(accountId: string, id: string, options?: RequestOptions): Promise<Response<AccountPerson>>;
    /**
