...
import { JapanAddressParam, MetadataParam } from '../../../../shared.js';
...
export declare class PersonTokenResource extends StripeResource {
    ...
    create(id: string, options?: RequestOptions): Promise<Response<AccountPersonToken>>;
    /**
    ...
    retrieve(accountId: string, id: string, options?: RequestOptions): Promise<Response<AccountPersonToken>>;
}
