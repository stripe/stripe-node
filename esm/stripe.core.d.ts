...
import { AppInfo, RawRequestOptions } from './lib.js';
...
type RequestSenderFactory = (stripe: StripeClient) => RequestSender;
export declare class StripeClient {
     ...
     * This may be removed in the future.
     */
    _setApiNumberField(prop: keyof StripeClient['_api'], n: number, defaultVal?: number): void;
     ...
     * This may be removed in the future.
     */
    _setApiField<K extends keyof StripeClient['_api']>(key: K, value: StripeClient['_api'][K]): void;
    /**
     * @private
     * Please open or upvote an issue at github.com/stripe/stripe-node
     * if you use this, detailing your use-case.
     ...
     * It may be deprecated and removed in the future.
     */
    getApiField<K extends keyof StripeClient['_api']>(key: K): StripeClient['_api'][K];
...
export declare function createStripe(platformFunctions: PlatformFunctions, requestSender?: RequestSenderFactory): typeof StripeClient;
export {};
