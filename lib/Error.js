...
StripeError.generate = function(rawStripeError) {
  return {
    'card_error': new _Error.StripeCardError(rawStripeError),
    'invalid_request_error': new _Error.StripeInvalidRequestError(rawStripeError),
    'api_error': new _Error.StripeAPIError(rawStripeError)
  }[rawStripeError.type] || new _Error('Generic', 'Unknown Error');
};
