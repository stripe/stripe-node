...
module.exports = StripeResource.extend({
  ...
  legacyUpdateSubscription: stripeMethod({
    method: 'POST',
    path: '{customerId}/subscription',
    urlParams: ['customerId'],
  }),

  newstyleUpdateSubscription: stripeMethod({
    method: 'POST',
    path: '/{customerId}/subscriptions/{subscriptionId}',
    urlParams: ['customerId', 'subscriptionId'],
  }),

  legacyCancelSubscription: stripeMethod({
    method: 'DELETE',
    path: '{customerId}/subscription',
    urlParams: ['customerId'],
  }),

  newstyleCancelSubscription: stripeMethod({
    method: 'DELETE',
    path: '/{customerId}/subscriptions/{subscriptionId}',
    urlParams: ['customerId', 'subscriptionId'],
  }),
  ...
  updateSubscription(customerId, subscriptionId) {
    if (typeof subscriptionId === 'string') {
      return this.newstyleUpdateSubscription.apply(this, arguments);
    }
    return this.legacyUpdateSubscription.apply(this, arguments);
  },
  ...
  cancelSubscription(customerId, subscriptionId) {
    ...
    if (typeof subscriptionId === 'string' && !utils.isAuthKey(subscriptionId)) {
      return this.newstyleCancelSubscription.apply(this, arguments);
    }
    return this.legacyCancelSubscription.apply(this, arguments);
  },
