...
module.exports = StripeResource.extend({
  ...
  retrieve(id) {
    // No longer allow an api key to be passed as the first string to this function due to
    // ambiguity between old account ids and api keys. To request the account for an api key, send
    // null as the id
    if (typeof id === 'string') {
      return stripeMethod({
        method: 'GET',
