...
const RequestSender_1 = require("./RequestSender");
...
const defaultRequestSenderFactory = (stripe) => new RequestSender_1.default(stripe, StripeResource_1.StripeResource.MAX_BUFFERED_REQUEST_METRICS);
