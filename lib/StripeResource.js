...
var StripeError = require('./StripeError');
...
StripeResource.prototype = {
  ...
  _timeoutHandler: function(timeout, req, callback) {
    var self = this;
    return function() {
      var timeoutErr = new StripeError('ETIMEDOUT');
      ...
      callback.call(
        self,
        new StripeError.StripeConnectionError({
        ...
        try {
          ...
          if (response.error) {
            ...
            if (res.statusCode === 401) {
              err = new StripeError.StripeAuthenticationError(response.error);
            } else {
              err = StripeError.StripeError.generate(response.error);
            }
          ...
          return callback.call(
            self,
            new StripeError.StripeAPIError({
