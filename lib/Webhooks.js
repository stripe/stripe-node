...
function createWebhooks(platformFunctions) {
    ...
    function parseEventDetails(encodedPayload, encodedHeader, expectedScheme) {
        ...
        if (typeof encodedPayload != 'string' &&
            ...
            throw new StripeSignatureVerificationError(encodedHeader, encodedPayload, {
                message: 'Webhook payload must be provided as a string or a Buffer/Uint8Array instance representing the _raw_ request body.' +
                    'Payload was provided as a parsed JavaScript object instead. \n' +
                    'Signature verification is impossible without access to the original signed material. \n' +
                    'Learn more about webhook signing and explore webhook integration examples at \n' +
