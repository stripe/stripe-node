...
const NodeHttpClient = require('./HttpClient').NodeHttpClient;
...
function Stripe(key, config = {}) {
  ...
  this._httpClient = new NodeHttpClient(props.protocol, {agent: props.agent});
...
Stripe.prototype = {
  ...
  setProtocol(protocol) {
    ...
    this._httpClient._setProtocol(protocol);
  },
