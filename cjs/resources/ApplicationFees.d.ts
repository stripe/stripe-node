...
export declare class ApplicationFeeResource extends StripeResource {
    ...
    retrieve(id: string, options?: RequestOptions): Promise<Response<ApplicationFee>>;
    /**
    ...
    retrieveRefund(feeId: string, id: string, options?: RequestOptions): Promise<Response<FeeRefund>>;
    /**
    ...
    updateRefund(feeId: string, id: string, options?: RequestOptions): Promise<Response<FeeRefund>>;
    /**
