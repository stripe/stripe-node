...
export declare class InvoiceRenderingTemplateResource extends StripeResource {
    ...
    retrieve(id: string, options?: RequestOptions): Promise<Response<InvoiceRenderingTemplate>>;
    /**
    ...
    archive(id: string, options?: RequestOptions): Promise<Response<InvoiceRenderingTemplate>>;
    /**
