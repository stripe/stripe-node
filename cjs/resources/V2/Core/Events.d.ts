...
export type Event = Events.V1BillingMeterErrorReportTriggeredEvent | Events.V1BillingMeterNoMeterFoundEvent | Events.V2CoreEventDestinationPingEvent;
export type EventNotification = Events.V1BillingMeterErrorReportTriggeredEventNotification | Events.V1BillingMeterNoMeterFoundEventNotification | Events.V2CoreEventDestinationPingEventNotification;
    ...
    namespace V1BillingMeterErrorReportTriggeredEvent {
        ...
        namespace Data {
            ...
            namespace Reason {
                ...
                namespace ErrorType {
                    export type Code = 'archived_meter' | 'meter_event_customer_not_found' | 'meter_event_dimension_count_too_high' | 'meter_event_invalid_value' | 'meter_event_no_customer_defined' | 'missing_dimension_payload_keys' | 'no_meter' | 'timestamp_in_future' | 'timestamp_too_far_in_past';
