...
export declare class ValueListResource extends StripeResource {
    ...
    del(id: string, options?: RequestOptions): Promise<Response<Radar.DeletedValueList>>;
    /**
...
export declare namespace Radar {
    ...
    namespace ValueList {
        type ItemType = 'card_bin' | 'card_fingerprint' | 'case_sensitive_string' | 'country' | 'customer_id' | 'email' | 'ip_address' | 'sepa_debit_fingerprint' | 'string' | 'us_bank_account_fingerprint';
    }
}
export declare namespace Radar {
