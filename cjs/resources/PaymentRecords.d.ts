...
export declare class PaymentRecordResource extends StripeResource {
    ...
    retrieve(id: string, options?: RequestOptions): Promise<Response<PaymentRecord>>;
    /**
    ...
    reportPaymentAttemptInformational(id: string, options?: RequestOptions): Promise<Response<PaymentRecord>>;
    /**
     * Report that the most recent payment attempt on the specified Payment Record
     *  was refunded.
     */
