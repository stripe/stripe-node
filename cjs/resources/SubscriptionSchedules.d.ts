...
export declare class SubscriptionScheduleResource extends StripeResource {
    ...
    retrieve(id: string, options?: RequestOptions): Promise<Response<SubscriptionSchedule>>;
    /**
    ...
    cancel(id: string, options?: RequestOptions): Promise<Response<SubscriptionSchedule>>;
    /**
    ...
    release(id: string, options?: RequestOptions): Promise<Response<SubscriptionSchedule>>;
}
export /**
